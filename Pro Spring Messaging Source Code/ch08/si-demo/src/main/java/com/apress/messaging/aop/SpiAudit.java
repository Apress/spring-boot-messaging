...
@Aspect
@Component
public class SpiAudit {
	private static final String DASH_LINE = "===================================";
	private static final String NEXT_LINE = "\n";
	private static final Logger log = LoggerFactory.getLogger(SpiAudit.class);

	@Pointcut("execution(public * com.apress.messaging.integration.*.*(..))")
	public void logSpi(){}
	
	@Pointcut("execution(public * com.apress.messaging.config.*.process(..))")
	public void logProcess(){}
	
	@Around("logSpi() || logProcess()")
