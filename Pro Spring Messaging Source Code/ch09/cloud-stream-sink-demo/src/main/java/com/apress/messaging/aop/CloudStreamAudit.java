...
@Aspect
@Component
public class CloudStreamAudit {

	private static final String DASH_LINE = "===================================";
	private static final String NEXT_LINE = "\n";
	private static final Logger log = LoggerFactory.getLogger(CloudStreamAudit.class);

	@Pointcut("execution(public * com.apress.messaging.cloud.stream.*.process(..))")
